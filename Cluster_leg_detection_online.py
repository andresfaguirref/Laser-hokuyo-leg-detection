...
Laser_lec = [] # List that contains the laser samples
Laser_lecture = False # Variable to begin or finish the lecture of the LRF
Time_LRF = [] # List that contains the time of each sample of the LRF
Laser_scan_regitry = [] # List that contains each list scan
